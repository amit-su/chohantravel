...
import { addStaff } from "../../redux/rtk/features/staff/staffslice";
...
const AddStaff = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (isChecked) {
        uppercaseValues.email = values.email;
        uppercaseValues.password = values.password;
      }
      const resp = await dispatch(addStaff(uppercaseValues, { dispatch }));
    ...
    <div className="h-full">
      ...
      >
        ...
        <div className="flex justify-center mt-[24px]">
          ...
          />{" "}
          <label htmlFor="staffCheckbox" className="mt-2 mr-4">
            Check me
          </label>
          <Button
            loading={loading}
