...
import { loadPowerbiToken } from "../../redux/rtk/features/powerBi/powerBiAdvanceToStaffRegisterSlice";

const AdvanceToStaffRegister = () => {
  const dispatch = useDispatch();
  const { data, loading } = useSelector(
    (state) => state.powerbiAdvanceToStaffRegister
  );
...
export default AdvanceToStaffRegister;
