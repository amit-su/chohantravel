...
function DriverLicenseExpirePrint() {
  ...
  useEffect(() => {
    if (!data) {
      dispatch(
        loadPowerbiToken({ reportId: "3f53a7d1-d6ab-4ba7-aca0-2d8fa4ecefd3" })
      );
    }
    if (data) {
      setReportInfo(data);
  ...
  return (
    <>
      <div className="text-center">
        <div className="">
          <h1>
            <strong>Driver License Expire </strong>
          </h1>
        </div>
        <div>
...
export default DriverLicenseExpirePrint;
