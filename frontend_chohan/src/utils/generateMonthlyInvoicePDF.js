...
export const generateMonthlyInvoicePDF = async (data, companyDetails = null) => {
                                        ...
                                        columns: [
                                            {
                                                ...
                                                stack: [
                                                    ...
                                                    { text: [{ text: 'Branch: ', style: 'compactLabel' }, { text: companyDetails ? companyDetails.BankBranchAddr : invoiceData.BankBranchAddr || '', style: 'compactText' }] },
            ...
            },
            {
                columns: [
                    ...
                    },
                    {
                        width: '40%',
                        stack: [
                            { text: 'FOR CHOHAN TOURS AND TRAVELS', style: 'compactLabel', alignment: 'right', margin: [0, 0, 0, 5] },
                            ...(stempImageBase64 ? [{
